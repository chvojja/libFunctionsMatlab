...
% system(['git add origin git@github.com:chvojja/' nv.Repository '.git  & git remote -v']); % ampersand separates the commands
system(['git remote add origin https://github.com/chvojja/' nv.Repository '.git  & git remote -v']); % ampersand separates the commands
%     !git add .
